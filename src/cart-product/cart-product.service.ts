...
export class CartProductService {
    ...
    async createCartProductInCart(insertCartDTO: InsertCartDTO, cartId: number): Promise<CartProductEntity> {
    ...
    async insertProductInCart(insertCartDTO: InsertCartDTO, cart: CartEntity): 
    ...
    async updateProductInCar(updateCartDTO: UpdateCartDTO, cart: CartEntity): 
    Promise<CartProductEntity> {
